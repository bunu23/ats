  ...
  const rules = [
    {
      ...
      description:
        'Auto-reject applications that stagnate in a pipeline stage for too long without an update.',
    ...
    },
    {
      ...
      description:
        'Automatically escalate candidate priority to High or Urgent if SLA is breached.',
    ...
    },
    {
      ...
      description:
        'Queue 24-hour and 1-hour reminders for candidates, and 24-hour recruiter notifications.',
    ...
    },
    {
      ...
      description:
        'Send a personalized note thanking the candidate a few hours after their interview.',
    ...
    },
    {
      ...
      description:
        'Enforce a 48-hour delay on automated and manual rejections before emailing the candidate.',
