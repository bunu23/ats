...
| **AI Screening $\rightarrow$ Phone Screen**     | ⏳ `≤ 24 hours`           | ⚡ **Fast-Tracked:** High-matching profiles (Score > 85) are instantly flagged for recruiter approval and automatically advanced to the Interview stage.          |
